...
<div class="container">
    ...
    <div class="row" style="margin-top: 20px">
        <div class="col-md-4 m-auto">
            <form method="post" action="${pageContext.request.contextPath}/user/reg" enctype="multipart/form-data"
                ...
                <div class="form-group has-feedback">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-key fa-fw"></i></span>
                        <input type="password" id="passwordSec" class="form-control" name="passwordSec"
                               placeholder="再次输入密码"/>
                    </div>
                </div>
