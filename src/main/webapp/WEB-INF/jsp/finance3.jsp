        ...
        <div class="col-md-10 col-md-offset-2">
            ...
            <div class="row" style="margin-left:20px ;margin-right:20px;">
             <div class="row gourpbtn">
                ...
                <button type="button" class="btn btn-success">三等奖</button>

                <!-- Contextual button for informational alert messages -->
                <button type="button" class="btn btn-info">二等奖</button>

                <!-- Indicates caution should be taken with this action -->
                <button type="button" class="btn btn-warning">一等奖</button>

                <!-- Indicates a dangerous or potentially negative action -->
                <button type="button" class="btn btn-danger">特等奖</button>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">2018年度奖金获得者名单</div>
                        <div class="panel-body">                   
                            <div class="alert alert-success" role="alert">
                                <strong>5K</strong><hr>王XX<br/>李XX<br/>张XX<br/>刘XX<br/>陈XX<br/>杨XX
                            </div>
                            <div class="alert alert-info" role="alert">
                                <strong>1W</strong><hr>黄XX<br/>赵XX<br/>吴XX
                            </div>
                            <div class="alert alert-warning" role="alert">
                                <strong>2W</strong><hr>周XX<br/>徐XX
                            </div>
                            <div class="alert alert-danger" role="alert">
                                <strong>5W</strong><hr>孙XX
                            </div>
