                        ...
                        <table class="table table-bordered table-hover" id="dataTable">
                            ...
                            <c:forEach var="project" items="${projectList}">
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-danger col-6 m-auto"
                                           href="${pageContext.request.contextPath}/page/deleteProject?projectId=${project.id}">删除</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-success col-6 m-auto"
                                           href="${pageContext.request.contextPath}/page/approveProject?projectId=${project.id}">通过</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
