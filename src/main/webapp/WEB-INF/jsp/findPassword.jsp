...
<div class="container">
    ...
    <div class="row" style="margin-top: 80px">
        <div class="col-md-4 m-auto">
            <form method="post" action="${pageContext.request.contextPath}/user/modifyPassword"
                  onsubmit="return checkWhenFindPassword()">
                <div class="form-group has-feedback">
                    <label class="sr-only"></label>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
                        <input type="tel" id="newPhone" class="form-control input-lg" name="newPhone"
                               placeholder="请输入手机号码"/>
                    </div>
                </div>
                ...
                <div class="form-group has-feedback">
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control input-lg" name="password" id="pas1"
                               placeholder="请输入新密码"/>
                    </div>
                </div>
