...
<div class="container">
    <div class="row" style="margin-top: 20px">
        <form class="col-10 m-auto" method="post" action="${pageContext.request.contextPath}/page/addBill">
            ...
            <div class="form-group">
                <label class="sr-only"></label>
                <input type="text" class="form-control" name="details" placeholder="请输入描述">
            </div>


            <div class="form-group">
                <label for="sel1" class="sr-only"></label>
                <select class="form-control" id="sel1" name="billType">
                    <option>收入</option>
                    <option>支出</option>
                </select>
            </div>
