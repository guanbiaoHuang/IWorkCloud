...
<div class="container">
    <div class="row" style="margin-top: 20px">
        <form class="col-10 m-auto" method="post" action="${pageContext.request.contextPath}/page/addBonus">
            <div class="form-group">
                <label class="sr-only"></label>
                <input type="text" class="form-control" name="id" placeholder="请输入流水号">
            </div>
            <div class="form-group">
                <label class="sr-only"></label>
                <input type="text" class="form-control" name="staff" placeholder="请输入工号">
            </div>
            ...
            <div class="form-group">
                <label class="sr-only"></label>
                <input type="text" class="form-control" name="mount" placeholder="请输金额">
            </div>


            <div class="form-group">
                <label for="sel1" class="sr-only"></label>
                <select class="form-control" id="sel1" name="bonusType">
                    <option>奖金</option>
                    <option>补贴</option>
                </select>
            </div>
            ...
            <div class="form-group">
                <label class="sr-only"></label>
                <button type="submit" id="submit" class="btn btn-block btn-success">添加奖金</button>
            </div>
