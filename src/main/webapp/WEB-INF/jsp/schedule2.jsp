            ...
            <div class="row" style="margin-left:20px ;margin-right:20px;">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">会议通知</div>
                        <div class="panel-body">
                            <ul class="list-group">
                                <li class="list-group-item list-group-item-info">							 
							        7月7日--通知，全体员工下周一下午14:30在103会议室开会，望准时到达！
                                <span class="badge">100已阅</span></li>
                            </ul>
                            <ul class="list-group">
                                <li class="list-group-item list-group-item-info">
							        7月10日--通知，全体员工本周五下午14:30在103会议室开会，望准时到达！
							    <span class="badge">100已阅</span></li>
                            </ul>
                            <ul class="list-group">
                                <li class="list-group-item list-group-item-info">
							        7月11日--通知，由于特殊原因，原定于本周五下午14:30在103的会议暂时取消，集体情况请等待后续通知，请相互转告！
							    <span class="badge">100已阅</span></li>
                            </ul>
                        </div>
                    </div>
			    ...
			    <div class="row" align="center">
			        <input type="text" class="form-control" style="height:40px;width:450px" placeholder="时间地点">
			        <div class="panel panel-info" style="width: 450px">
			            <div class="panel-heading">
			                <h3 class="panel-title" align="center">具体内容</h3>
			            </div>
